//
//  cliente7.cpp  --> Programa utilizando Socket UDP Multicast
//  
//
//  Created by Luiz Affonso on 01/12/2020.
//
//
...
int main( )
{
    ...
    //address.sin_addr.s_addr = inet_addr("10.13.96.16"); // IP do Servidor
